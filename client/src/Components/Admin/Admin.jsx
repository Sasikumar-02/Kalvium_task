        ...
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            <p className="text-lg text-black-100 leading-loose">
              A Full Stack Web Developer 🚀 from Dharmapuri, India, currently 💻 I'm pursuing my Bachelor of Computer Science and Engineering at Erode. I am passionate about technology and want to learn & explore new technologies. I love travelling and doing farming in free time.
            </p>
          </div>
